...
export class ContentController {
  ...
  public static async createModule(req: Request, res: Response): Promise<void> {
    try {
      ...
      const moduleObj = await ContentService.createModule(courseId, { title, description, isPublished }, req.user);
  ...
  public static async updateModule(req: Request, res: Response): Promise<void> {
    try {
      ...
      const updatedModule = await ContentService.updateModule(courseId, moduleId, { title, description, isPublished }, req.user);
  ...
  public static async createLesson(req: Request, res: Response): Promise<void> {
    try {
      ...
      const lesson = await ContentService.createLesson(courseId, moduleId, { title, description, content, isPublished }, req.user);
  ...
  public static async updateLesson(req: Request, res: Response): Promise<void> {
    try {
      ...
      const updatedLesson = await ContentService.updateLesson(courseId, moduleId, lessonId, { title, description, content, isPublished }, req.user);
